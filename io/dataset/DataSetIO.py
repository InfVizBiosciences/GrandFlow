...
from grandflow.chemistry.chemistry import ChemistryLookupError
from grandflow.io.align.PacBioBamIndex import PBI_FLAGS_BARCODE
from grandflow.io.FastaIO import splitFastaHeader, FastaWriter
from grandflow.io.FastqIO import FastqReader, FastqWriter, qvsFromAscii
from grandflow.io import (BaxH5Reader, FastaReader, IndexedFastaReader,
                       CmpH5Reader, IndexedBamReader, BamReader)
from grandflow.io.align._BamSupport import UnavailableFeature
from grandflow.io.dataset.DataSetReader import (parseStats, populateDataSet,
                                             resolveLocation, xmlRootType,
                                             wrapNewResource, openFofnFile,
                                             parseMetadata, checksts)
from grandflow.io.dataset.DataSetWriter import toXml
from grandflow.io.dataset.DataSetValidator import validateString
from grandflow.io.dataset.DataSetMembers import (DataSetMetadata,
                                              SubreadSetMetadata,
                                              ContigSetMetadata,
                                              BarcodeSetMetadata,
                                              ExternalResources,
                                              ExternalResource, Filters)
from grandflow.io.dataset.utils import (_infixFname, _pbindexBam,
                                     _indexBam, _indexFasta, _fileCopy,
                                     _swapPath, which, consolidateXml,
                                     getTimeStampedName, getCreatedAt)
from grandflow.io.dataset.DataSetErrors import (InvalidDataSetIOError,
                                             ResourceMismatchError)
from grandflow.io.dataset.DataSetMetaTypes import (DataSetMetaTypes, toDsId,
                                                dsIdToSuffix)
from grandflow.io.dataset.DataSetUtils import fileType
...
class DataSet(object):
    ...
    def __init__(self, *files, **kwargs):
        ...
        Doctest:
            >>> import os, tempfile
            >>> import grandflow.data.datasets as data
            >>> from grandflow.io import AlignmentSet, SubreadSet
    ...
    def __add__(self, otherDataset):
        ...
        Doctest:
            >>> import grandflow.data.datasets as data
            >>> from grandflow.io import AlignmentSet
            >>> from grandflow.io.dataset.DataSetWriter import toXml
    ...
    def copy(self, asType=None):
        ...
        Doctest:
            >>> import grandflow.data.datasets as data
            >>> from grandflow.io import DataSet, SubreadSet
    ...
    def write(self, outFile, validate=True, modPaths=None,
        ...
        Doctest:
            >>> import grandflow.data.datasets as data
            >>> from grandflow.io import DataSet
            >>> import tempfile, os
            >>> outdir = tempfile.mkdtemp(suffix="dataset-doctest")
    ...
    def addFilters(self, newFilters, underConstruction=False):
        ...
        Doctest:
            >>> import grandflow.data.datasets as data
            >>> from grandflow.io import SubreadSet
            >>> from grandflow.io.dataset.DataSetMembers import Filters
            >>> ds1 = SubreadSet()
            >>> filt = Filters()
    ...
    def addExternalResources(self, newExtResources, updateCount=True):
        ...
        Doctest:
            >>> from grandflow.io.dataset.DataSetMembers import ExternalResource
            >>> from grandflow.io import DataSet
            >>> ds = DataSet()
    ...
    def resourceReaders(self):
        """Return a list of open grandflow Reader objects for the
...
class SubreadSet(ReadSet):
    ...
    DocTest:
        ...
        >>> from grandflow.io import SubreadSet
        >>> from grandflow.io.dataset.DataSetMembers import ExternalResources
        >>> import grandflow.data.datasets as data
...
class ConsensusReadSet(ReadSet):
    ...
    Doctest:
        >>> import grandflow.data.datasets as data
        >>> from grandflow.io import ConsensusReadSet
